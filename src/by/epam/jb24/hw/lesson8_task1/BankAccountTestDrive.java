...
public class BankAccountTestDrive {
	...
	public static void main(String[] args) {
		...
		myListOfAccounts.addListOfAccounts(new BankAccount("0001", "debit", 1000));
		myListOfAccounts.addListOfAccounts(new BankAccount("0002", "debit", 3000));
		myListOfAccounts.addListOfAccounts(new BankAccount("0003", "credit", 5000));
		myListOfAccounts.addListOfAccounts(new BankAccount("0004", "debit", 1000));
		myListOfAccounts.addListOfAccounts(new BankAccount("0001", "debit", 1000));
		...
		System.out.println("");
		System.out.println("-----------------------------------------------------------------------");
		System.out.println("Check if we already has object b3 in our myListOfAccounts array list: ");
		System.out.println("-----------------------------------------------------------------------");
